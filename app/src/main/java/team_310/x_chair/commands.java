...
class commands {
    ...
    */
    //////for DVD///////////////
    static final int FORWARD = 0x61;
    static final int BACKWARD = 0x60;
    static final int LEFT = 0x50;
    static final int RIGHT = 0x51;
    static final int BRAKE = 0x62;
    static final int SPEEDUP = 0x10;
    static final int SPEEDDOWN = 0x11;
    ...
    static final int LIGHTS_YELLOW = 0x78;
    static final int LIGHTS_BLUE = 0x74;
    static final int LIGHTS_RAINBOW = 0x41;
}
